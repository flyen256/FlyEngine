...
namespace FlyEngine.Editor.Scripting;
    ...
    public async Task CompileScriptsAsync()
    {
        ...
        try
        {
            ...
            var compilationResult = await Task.Run(() => 
            {
                ...
                var compilation = CSharpCompilation.Create(Core.Scripting.Scripting.ScriptsAssemblyName)
            ...
            if (compilationResult.Success)
            {
                ...
                Application.ScriptsLoader.Unload();
                Application.ScriptsLoader = new AssemblyLoadContext("ScriptsAssemblyContext", isCollectible: true);
                Application.ScriptsLoader.LoadFromStream(compilationResult.Stream);
