    ...
    public async Task CompileScriptsAsync()
    {
        ...
        try
        {
            ...
            var compilationResult = await Task.Run(() =>
            {
                ...
                const string implicitUsingsCode = 
                    """
                    // <auto-generated/>
                    ...
                    """;
                var implicitUsingsTree = CSharpSyntaxTree.ParseText(implicitUsingsCode, path: "FlyEngine_ImplicitUsings.g.cs");
            ...
            else
            {
                ...
                foreach (var fileErrors in errors)
                {
                    ...
                    Debug.LogError($"Errors in {fileErrors.Key}:");
                    foreach (var diagnostic in fileErrors)
                    {
                        ...
                        Debug.LogError($"  Line {lineSpan.StartLinePosition.Line + 1}: {diagnostic.GetMessage()}");
                    }
                }
            }
        }
